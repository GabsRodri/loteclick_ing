...
return (
  <section className="w-full min-h-screen bg-gradient-to-br from-background to-muted/40 py-8 px-4 sm:px-6 lg:px-12">
    <div className="flex flex-col items-center text-center mb-8">
      ...
      <h1 className="mt-2 text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-2 dark:text-gray-100">
        ¡Bienvenido a LoteClick!
      </h1>
      <p className="text-base sm:text-lg lg:text-xl text-muted-foreground dark:text-gray-100">
        Estás autenticado como{" "}
        <span className="font-semibold text-foreground dark:text-gray-400">{role}</span>
      </p>
    </div>

    <div className="mt-10 grid gap-6 sm:gap-8 md:gap-10 lg:gap-14 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center">
      {role === "admin" && (
        <>
    ...
    {/* Footer */}
    <footer className="mt-12 text-center border-primary/40 text-sm sm:text-base text-muted-foreground dark:text-gray-400 border-t pt-4 dark:border-gray-700">
