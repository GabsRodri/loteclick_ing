...
export default async function DashboardPage() {
  ...
  <section className="w-full min-h-screen bg-gradient-to-br from-background to-muted/40 py-8 px-4 sm:px-6 lg:px-12">
    <div className="flex flex-col items-center text-center mb-8">
      ...
      <div className="flex-shrink-0 mb-4">
        <Image
          ...
          width={120}
          height={120}
          className="dark:hidden w-24 sm:w-36"
          priority
        />
        <Image
          src="/logo-dark.png"
          ...
          width={120}
          height={120}
          className="hidden dark:block w-24 sm:w-36"
          priority
        />
      </div>
    ...
    <div className="mt-10 grid gap-8 sm:gap-10 lg:gap-14 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center">
      {role === "admin" && (
        <>
